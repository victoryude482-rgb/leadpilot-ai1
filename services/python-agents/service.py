...
REASONING_AGENTS={"trend-finder","opportunity-finder","tender-finder","ecommerce-opportunity","workpilot","content","competitor-monitor","outreach","website-brand","gbp-audit","gbp-outreach","gbp-fix"}
...
def website_brand(payload:dict[str,Any])->dict[str,Any]:
 query=str(payload.get("query","")).strip() or "business website"
