...
export function decideClientReply(message: CommunicationMessage, context: string[] = []): CommunicationDecision {
  ...
  if (/website|web site|site/.test(lower)) reply = 'Absolutely. We can look at what you need the website to do, the pages you want, and any features such as bookings, payments, or a shop. If you share a few details, I can help map out the right approach.';
  else if (/hello|hi|hey\b/.test(lower)) reply = 'Hi! Thanks for reaching out. What can I help you with?';
