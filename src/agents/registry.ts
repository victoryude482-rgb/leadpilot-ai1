...
export const AGENTS: AgentDefinition[] = [
  ...
  { id: 'command-agent', name: 'AI Command Agent', description: 'Describe the outcome you want in plain language and route it to the right agents.', category: 'research', status: 'live', capabilities: ['natural-language commands', 'intent routing', 'multi-agent chains', 'result summaries'] },
  { id: 'workpilot', name: 'WorkPilot AI', description: 'Find work opportunities, score them, understand the client problem and prepare a solution plan and proposal.', category: 'research', status: 'beta', capabilities: ['job discovery', 'multi-marketplace search', 'problem solving', 'proposal drafting', 'match scoring'] },
  { id: 'website-brand', name: 'AI Website & Brand Agent', description: 'Turn a business idea into an editable website structure and logo asset.', category: 'content', status: 'beta', capabilities: ['website generation', 'JSON-first editing', 'logo generation', 'brand concepts'] },
  { id: 'gbp-audit', name: 'GBP Audit Agent', description: 'Audit public listing health using directory evidence, with an optional Google Places check.', category: 'research', status: 'beta', capabilities: ['listing audit', 'website reachability', 'issue scoring', 'evidence reporting'] },
  { id: 'gbp-outreach', name: 'GBP Outreach Agent', description: 'Draft personalized, approval-first outreach from specific listing issues.', category: 'sales', status: 'beta', capabilities: ['issue-based personalization', 'eligibility guard', 'email drafts', 'approval-first outreach'] },
  { id: 'gbp-fix', name: 'GBP Fix Agent', description: 'Deliver a concrete listing-fix plan only after a lead reaches CUSTOMER status.', category: 'sales', status: 'beta', capabilities: ['deal gating', 'fix planning', 'CRM handoff', 'revenue attribution'] },
];
