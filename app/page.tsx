  ...
  return (
    <main className="shell">
      <header className="topbar">
        ...
        <span className="badge">B2B LEAD INTELLIGENCE</span>
      </header>
      ...
      <section className="panel">
        <div className="panelTitle"><div><h2>Lead Finder</h2><p>Tell LeadPilot who you want to sell to.</p></div><span className="live"><i /> API READY</span></div>
